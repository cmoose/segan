 ...
 */
public class CorenlpStopwordRemoval {

    private HashSet<String> stopwords;

    public CorenlpStopwordRemoval() {
        this.stopwords = new HashSet<String>(Arrays.asList(sws));
    }

    public CorenlpStopwordRemoval(String stopwordFile) {
        try {
